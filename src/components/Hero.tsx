      ...
      <div className="container mx-auto text-center">
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-gray-400 mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>shahzaibsdigitalworld@gmail.com</span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <button
            ...
            className="bg-gradient-to-r from-amber-500 to-yellow-600 text-black px-8 py-4 rounded-full font-semibold text-lg hover:from-amber-400 hover:to-yellow-500 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            Get In Touch
          </button>
        </div>
